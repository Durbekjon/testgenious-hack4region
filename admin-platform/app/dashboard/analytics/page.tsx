...
export default function AnalyticsPage() {
  ...
  // Recent tests data
  const recentTests = [
    { name: "Algebra Fundamentals", subject: "Mathematics", participants: 32, avgScore: 78, date: "2023-12-10" },
    { name: "Cell Biology Basics", subject: "Science", participants: 45, avgScore: 82, date: "2023-12-08" },
    { name: "Grammar and Punctuation", subject: "English", participants: 38, avgScore: 75, date: "2023-12-05" },
    { name: "World War II Overview", subject: "History", participants: 29, avgScore: 81, date: "2023-12-03" },
    { name: "JavaScript Fundamentals", subject: "Programming", participants: 24, avgScore: 73, date: "2023-11-30" },
  ]
